...
const DEFAULTS = {
  modules: {},
  system: { initTimeout: 10000, suspendTimeout: 5000, hotReload: false, maxConcurrentAgents: 10, cpuLoadThreshold: 0.8, cpuLoadHardCap: 2.0, minFreeMemoryPct: 10, agentTimeoutMinutes: 10, spawnThrottleStreakLimit: 5 },
};
