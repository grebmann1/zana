...
export function saveTeam(team) {
  ...
  if (!team.orchestratorProfileId) team.orchestratorProfileId = "built-in-orchestrator";
...
const TEAM_TEMPLATES = [
  {
    ...
    orchestratorProfileId: "built-in-orchestrator",
    slots: [
      { profileId: "built-in-full-auto-coder", quantity: 3 },
      { profileId: "built-in-code-reviewer", quantity: 1 },
      { profileId: "built-in-test-writer", quantity: 2 },
      { profileId: "built-in-doc-generator", quantity: 1 },
    ],
  ...
  },
  {
    ...
    orchestratorProfileId: "built-in-orchestrator",
    slots: [
      { profileId: "built-in-architect", quantity: 1 },
      { profileId: "built-in-ux-designer", quantity: 1 },
      { profileId: "built-in-frontend-dev", quantity: 2 },
    ],
  ...
  },
  {
    ...
    slots: [
      { profileId: "built-in-architect", quantity: 1 },
      { profileId: "built-in-backend-dev", quantity: 2 },
      { profileId: "built-in-test-writer", quantity: 1 },
    ],
  ...
  },
  {
    ...
    slots: [
      { profileId: "built-in-architect", quantity: 1 },
      { profileId: "built-in-ux-designer", quantity: 1 },
      { profileId: "built-in-frontend-dev", quantity: 1 },
      { profileId: "built-in-backend-dev", quantity: 1 },
      { profileId: "built-in-code-reviewer", quantity: 1 },
    ],
  ...
  },
  {
    ...
    orchestratorProfileId: "built-in-orchestrator",
    slots: [
      { profileId: "built-in-read-only-explorer", quantity: 3 },
      { profileId: "built-in-security-auditor", quantity: 2 },
      { profileId: "built-in-doc-generator", quantity: 1 },
    ],
  ...
  },
  {
    ...
    orchestratorProfileId: "built-in-orchestrator",
    slots: [
      { profileId: "built-in-code-reviewer", quantity: 2 },
      { profileId: "built-in-security-auditor", quantity: 1 },
      { profileId: "built-in-test-writer", quantity: 1 },
    ],
